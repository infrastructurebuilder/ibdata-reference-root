...
public class TransformationTest {
  ...
  private DefaultIBTransformation t;

  @Before
  public void setUp() throws Exception {
    t = new DefaultIBTransformation();
  }

  @Test
  public void testSimpleGetSet() {
    assertEquals(IBTransformation.DEFAULT_TRANSFORM, t.getFinalizer());
    t.setFinalizer("A");
    ...
    assertEquals(IBTransformation.DEFAULT, t.getId());
    t.setId("A");
